...
class Arc(BaseElement):
    ...
    def __init__(self, loc: Tuple[int] = (0, 0), size: Tuple[int] = (100, 100), start_angle: float = 1.57, stop_angle: float,
            color: Tuple[int], border: int, border_color: Tuple[int], antialias: bool) -> None:
        """
        Initializes arc.
